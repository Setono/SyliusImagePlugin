...
INFO)
                ...
                ->arrayNode('filter_sets')
                    ...
                    ->end()
                ->end()
                ->arrayNode('processable_resources')
                    ->info('The sylius resources you want to process using this plugin. If no resources are specified, all resources which implements ImageInterface are processed')
                    ...
                    ->arrayPrototype()
                        ->children()
                            ->scalarNode('resource')
                                ->info('The name of the sylius resource')
                                ->cannotBeEmpty()
                            ->end()
                            ->arrayNode('variants')
                                ->info('A list of the variants/filter sets you want to generate for this resource. If nothing is specified, all variants will be generated.')
                                ->scalarPrototype()->end()
                            ->end()
                        ->end()
                    ->end()
